 ...
 if let markingGraph = model.markingGraph(from: initialMarking) {
     ...
     //4.1
     print("Combien y a t'il d'états différents : ")
     print(model.count(mark: markingGraph))


     //4.2
     print("Peut-il y avoir deux fumeurs en même temps : ")
     print(model.moreThanTwo(mark: markingGraph))


     //4.3
     print("Est-il possible d’avoir deux fois le même ingrédient sur la table : ")
